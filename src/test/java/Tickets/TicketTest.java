...
class TicketTest {
    ...
    public void shouldFindFewTickets() {
        ...
        Ticket ticket6 = new Ticket(6, "MSK", "SPB", 900, 93);
        Ticket ticket7 = new Ticket(7, "LA", "NY", 10000, 298);
        Ticket ticket8 = new Ticket(8, "OMSK", "MSK", 1000, 99);
        ...
        Ticket[] expected = {ticket8, ticket4};
        Ticket[] actual = manager.findAll("OMSK", "MSK");
    ...
    public void notFindAnyTicket() {
        ...
        Ticket[] expected = {};
        Ticket[] actual = manager.findAll("IST", "KAZ");
